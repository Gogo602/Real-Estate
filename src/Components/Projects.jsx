...
const Projects = () => {
  ...
  return (
      <motion.div
            ...
            viewport={{once:true}}
          className='container mx-auto  pt-5 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden' id='Projects'>
          <h2 className='text-2xl sm:text-4xl font-bold mb-2 text-center'>Projects <></>
