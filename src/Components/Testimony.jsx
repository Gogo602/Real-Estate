        ...
        whileInView={{ opacity: 1, x: 0 }}
          ...
          <div className='flex flex-wrap justify-center gap-8'>
              {testimonialsData.map((testimonial, index) => (
                  <div key={index} className='max-w-[320px] border shadow-lg rounded px-8 py-8 text-center'>
                      <img className='w-18 h-20 rounded-full mx-auto mb-4' src={testimonial.image} alt={testimonial.alt} />
